...
void readIP(union IPAddress *ip, int *e) {
  printf("Inserisci un indirizzo IP e il suo CIDR:\n");
...
int main() {
  ...
  printf("\n\nIP di Rete: %d.%d.%d.%d\n", (int)((networkIP >> 24) & 0xFF),
         (int)((networkIP >> 16) & 0xFF), (int)((networkIP >> 8) & 0xFF),
         (int)(networkIP & 0xFF));
  printf("IP Primo Host: %d.%d.%d.%d\n", (int)((firstHostIP >> 24) & 0xFF),
         (int)((firstHostIP >> 16) & 0xFF), (int)((firstHostIP >> 8) & 0xFF),
         (int)(firstHostIP & 0xFF));
  printf("IP Ultimo Host: %d.%d.%d.%d\n", (int)((lastHostIP >> 24) & 0xFF),
         (int)((lastHostIP >> 16) & 0xFF), (int)((lastHostIP >> 8) & 0xFF),
         (int)(lastHostIP & 0xFF));
  printf("IP Broadcast: %d.%d.%d.%d\n", (int)((broadcastIP >> 24) & 0xFF),
         (int)((broadcastIP >> 16) & 0xFF), (int)((broadcastIP >> 8) & 0xFF),
         (int)(broadcastIP & 0xFF));
